...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  late final Future<DocumentSnapshot> _productFuture;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final unitPrice = _parsePrice(productData['price']);
        final description =
            ...
            child: Column(
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children:
                        List.generate((productData['colors'] as List).length,
                            (index) {
                        ...
                        onTap: () {
                          setState(() {
                            ...
                            if (productData['colorImages'] != null &&
                                (productData['colorImages'] as List).length >
                                    index) {
                              displayedImage =
                                  productData['colorImages'][index];
                            }
                          });
                        },
                        child: Container(

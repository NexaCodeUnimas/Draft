  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        automaticallyImplyLeading: _currentIndex != 0, // Hide back button on Dashboard
...
// Placeholder pages (replace later with real admin pages)
...
class OrdersPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text("Orders Content"));
  }
}
